...
class MainActivity : AppCompatActivity(),GroceryRVAdapter.GroceryItemCliclInterface{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val grocerRepository=GrocerRepository(GroceryDatabase.invoke(this))
        val factory = GroceryViewModalFactory(grocerRepository)
     ...
     fun openDialog() {
         ...
         dialog.setContentView(R.layout.grocer_add_dialog)
